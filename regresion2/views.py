...
PAQUETE = joblib.load('modelo/modelo_regresion_multipla_completo3.pkl')
...
def prediccion_transfusiones2(request):
    resultado = None
    error = None
    mae = rmse = r2 = None
    ...
    return render(request, 'regresion2/regresion2.html', {
        "resultado": resultado,
        "error": error,
        "mae": mae,
        "rmse": rmse,
