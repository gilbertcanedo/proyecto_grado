...
PAQUETE = joblib.load('modelo/modelo_regresion_multipla_completo4.pkl')
...
def prediccion_transfusiones3(request):
    resultado = None
    error = None
    mae = rmse = r2 = None
    ...
    return render(request, 'regresion3/regresion3.html', {
        "resultado": resultado,
        "error": error,
        "mae": mae,
        "rmse": rmse,
