...
PAQUETE = joblib.load('modelo/modelo_regresion_multipla_completo1.pkl')
...
def prediccion_transfusiones(request):
    resultado = None
    error = None
    mae = rmse = r2 = None
    ...
    return render(request, 'regresion/regresion.html', {
        "resultado": resultado,
        "error": error,
        "mae": mae,
        "rmse": rmse,
...
def prediccion(request):
    ...
    return render(request, 'regresion/regresion_base.html')